            ...
            p = function() {
                function e(t) {
                    ...
                    this.eventBus = new c.default, this.eventBus.gameId = this.options.gameId + "", this.eventBus.subscribe("SDK_BLOCKED", function(e) 
                    {
                        ...
                        return n._onEvent(e)
                    }), this.eventBus.subscribe("AD_BREAK_REAdDY", function(e) {
                        return n._onEvent(e)
                ...
                return s(e, [{
                   ...
                   key: "showBanner",
                    value: function() {
                        ...
                        if(adxAds2 == true)  {
                            var descriptionURL = encodeURIComponent(window.location);
                            localStorage.setItem("gd_tag", "https://pubads.g.doubleclick.net/gampad/ads?iu=/21739493398/GameMonetizeSSS.net-ADX-AFG-Preroll-Ads&description_url=" + descriptionURL + "&tfcd=0&npa=0&sz=640x480&gdfp_req=1&output=vast&unviewed_position_start=1&env=vp&impl=s&correlator=");
